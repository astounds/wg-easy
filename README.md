...
| `WG_MTU` | `null` | `1384` | The MTU the clients will use. |
| `WG_SRV_MTU` | `1420` | `1420` | The MTU the Server will use. |
| `WG_PERSISTENT_KEEPALIVE` | `0` | `25` | Value in seconds to keep the "connection" open. If this value is 0, then connections won't be kept alive. |
| `WG_DEFAULT_ADDRESS` | `10.8.0.0` | `10.6.0.0` | Clients IPv4 address range. |
...
| `WG_DEFAULT_ADDRESS_RANGE6` | `64` | `128` | Value to define CIDR Range. If not defined fallback to `64`
